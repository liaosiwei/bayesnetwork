    ...
    public static void main(String[] args) {
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                //Integer datehash = Integer.valueOf(date[0]) * 31 + Integer.valueOf(date[1]); // result number is 41
                //Integer datehash = Integer.valueOf(date[0]); // result number is 51
                Integer datehash = 1;  // result number is 101
            ...
            for (String key1: table.keySet()) {
                ...
                *   save = true
                *     car = true
                *     0.2, 0.8 // buy=true and buy=false
                *     car = false
                *     0.5, 0.5 // true and false
                *   save = false
                *     car = true
                *     X, X // true and false
                *     car = false
